...
const customSeriesOrder = [
  "2026 南夢宮·追憶迴廊ノ導","2026 手作社","2026 鬼滅全編再放送CAFE·立志","2026 宅麵聯名","2026 AJ","2026 明治村聯名","2026 情人節","2026 節分","2026 幽浮桌BAR","2026 干支午年","2026 JUMPFES", 
...
const detailConfig = { 
  ...
  "南夢宮·南嘉堂":["2026 南夢宮·追憶迴廊ノ導","2025 南嘉堂·貓耳","2025 南夢宮·漆ノ章","2024 南嘉堂·いこいの里巡り其の弐","2024 南夢宮·陸ノ章","2023 南嘉堂·いこいの里巡り","2023 南夢宮·伍ノ章","2022 南嘉堂·祭日和","2022 南夢宮·肆ノ章","2021 南嘉堂·猫との穏やかな日々","2021 南夢宮·参ノ章","2020 南夢宮·壱ノ章"], 
...
function displayProducts(items, reset=true){
    ...
    items.forEach(item => {
        ...
        <div class="card" id="product-${id}">
            ...
            ${item.eventUrl ? `<p>活動網址：<a href="${item.eventUrl}" target="_blank">點我前往</a></p>` : ""}
            <p>類型：${item.type}</p>
            <p>尺寸：${item.size}</p>
